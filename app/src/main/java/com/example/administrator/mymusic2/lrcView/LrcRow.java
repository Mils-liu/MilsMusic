...
import com.example.administrator.mymusic2.lrcView.LrcRowShowMode;
import com.example.administrator.mymusic2.lrcView.LrcShowRow;

import java.util.ArrayList;
import java.util.List;

public class LrcRow implements Comparable<com.example.administrator.mymusic2.lrcView.LrcRow> {
    ...
    @Override
    public int compareTo(com.example.administrator.mymusic2.lrcView.LrcRow another) {
