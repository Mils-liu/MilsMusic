...
public class PlayActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button mode_play, list_music, play_right, play_left, btn_getLrc;
    ...
    private void init() {
        ...
        btn_getLrc = (Button) findViewById(R.id.btn_getLrc);
        ...
        btn_getLrc.setOnClickListener(this);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.centerLayout://隐藏音乐转盘显示歌词界面
                ...
                break;
            case R.id.btn_getLrc:
                btn_getLrc.setText("获取歌词中...");
    ...
    private void getLocalLrc(final String music_name) {
        if (checkLrcFile(music_name)) {//判断本地是否已存在歌词文件
            showLrc(dirfile);
            btn_getLrc.setVisibility(GONE);
        }else {
            showLrc(null);
            btn_getLrc.setVisibility(View.VISIBLE);
        }
    }
    ...
    private void cycle_all(String state) {
        ...
        playBtn.setImageResource(R.drawable.pause);
        MusicActivity.STATE = getResources().getString(R.string.play);
        getLocalLrc(music.getMusicName());
