...
import com.example.administrator.mymusic2.lrcView.IRowsParser;
...
public class DefaultLrcRowsParser implements IRowsParser {
    ...
    @Override
    public List<com.example.administrator.mymusic2.lrcView.LrcRow> parse(String lrcRowDada) {
        try {
            ...
            List<com.example.administrator.mymusic2.lrcView.LrcRow> listTimes = new ArrayList<com.example.administrator.mymusic2.lrcView.LrcRow>();
            for (String temp : arrTimes) {
                if (temp.trim().length() == 0) {
                    continue;
                }

                com.example.administrator.mymusic2.lrcView.LrcRow lrcRow = new LrcRow(content, temp, timeConvert(temp));
